    ...
    Vue.component('stm-manage-post-type', {
        ...
        methods: {
            ...
            updateCourse(post) {
                ...
                _this.$http.get(stm_lms_ajaxurl + '?action=stm_lms_pro_udemy_import_courses&id=' + post.id + '&update=true').then(function (r) {
                    var r = r.body;

                    _this.$set(post, 'loading_text', r.message);

                    _this.$http.get(stm_lms_ajaxurl + '?action=stm_lms_pro_udemy_import_curriculum&id=' + r.course_id + '&update=true').then(function (r) {
                        var r = r.body;
